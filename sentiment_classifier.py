...
if __name__ == "__main__":
    ...
    test_articles = [
        ...
        NewsArticle(
            id="TEST_002",
            title="Banking sector shows no growth amid concerns",
            content="The banking sector reported stagnant performance with no significant growth observed this quarter.",
            source="Test",
            timestamp=datetime.now()
        ),
        NewsArticle(
    ...
    print("=" * 80)
    print("Production-Grade Sentiment Analysis Tests")
    print("=" * 80)
