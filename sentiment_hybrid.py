...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("Hybrid Sentiment Classifier Tests")
    print("=" * 80)
    ...
    test_articles = [
        ...
        NewsArticle(
            ...
            content="The banking sector reported losses that narrowed by 40% compared to last quarter, signaling strong recovery momentum.",
            source="Test",
            timestamp=datetime.now()
        ),
        NewsArticle(
    ...
    for method in ["rule_based", "finbert", "hybrid"]:
        print(f"\n{'=' * 80}")
        print(f"Testing Method: {method.upper()}")
        print('=' * 80)
        
        try:
            classifier = HybridSentimentClassifier(method=method)
            print(f"Method Info: {classifier.get_method_info()}")
