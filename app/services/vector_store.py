...
class VectorStore:
    ...
    def create_embedding(self, text: str) -> List[float]:
        """Generate embedding using the configured model. Centralized for consistency."""
    ...
    def index_article(
        ...
        """Index article with enriched metadata, reusing embedding if provided."""
    ...
    def search(
        ...
        """Search for articles with metadata filtering. Returns formatted results."""
